...
INCLUDEPATH = -Isgfx -Ikernel -Ikernel/include -Ikernel/qgui -Ikernel/res
CFLAGS = -g -nostdlib -ffreestanding -m32 -fno-builtin -Isgfx -Ikernel -Ikernel/include -Ikernel/qgui -Ikernel/res -Ikernel/fats -no-pie
